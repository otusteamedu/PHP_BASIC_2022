...
require 'db/queryBooksAll.php';
require 'db/querySearchBooks.php';

/**
 * Сформировать список книг из БД для отображения в таблице в зависимости от характера запроса (поиск книг или весь список).
 * 
