...
if(!empty($_COOKIE['remember_token'])) {
    $result = authenticateFromRememberToken($_COOKIE['remember_token']);
    if($result === false) {
...
<section class="container">
    ...
    <div class="alert alert-danger mt-3" role="alert" style="display: none" id="alert"></div>

    <?php if (empty($_SESSION['token'])): ?>
        <form action="auth.php" method="post" enctype="multipart/form-data" class="mt-3">
        ...
        foreach ($rows as $row) {
            ...
            <div class="row mt-3 bg-light">
                ...
                foreach ($row as $col) {
                    ...
                    <div class="col-4">
                        <div class="card">
                            <a href="<?= 'details.php?' . base64_encode(DIR_IMG . '/' . $col) ?>" target="_blank"><img
